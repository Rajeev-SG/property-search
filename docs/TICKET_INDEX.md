...
| 3 | `003` | Canonical schema and domain contract expansion | `not_started` | `001`, `002` | High | Make the domain contracts explicit enough for extraction, normalization, dedupe, and indexing to proceed without ambiguity. | `docs/backlog/003-canonical-schema-and-domain-contract-expansion.md` | `yes` |
