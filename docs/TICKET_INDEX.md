...
| 8 | `008` | Crawl, fetch, and render pipeline foundation | `not_started` | `005`, `006`, `007` | High | Implement the local fetch/render pipeline and persist replayable artifacts and failures. | `docs/backlog/008-crawl-fetch-and-render-pipeline-foundation.md` | `yes` |
