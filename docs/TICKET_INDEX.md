...
| 4 | `004` | Database schema and migration baseline | `not_started` | `002`, `003` | High | Establish the initial Postgres schema and migration flow for core pipeline records. | `docs/backlog/004-database-schema-and-migration-baseline.md` | `yes` |
